...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		$updateQuery = "UPDATE user SET nama = :nama, email = :email, role = :role";
		$params = array(':nama' => $nama, ':email' => $email, ':role' => $role);
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							...
							<select name="role" required class="form-control">
								...
								<option value="1" <?php if ($data['role'] == 1) echo "selected"; ?>>Administrator</option>
