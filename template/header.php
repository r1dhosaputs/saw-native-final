  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="mt-5" style="display: inline-block; font-size: 10px;">
          <br> <br>
          <img src="/SPK-SAW-NATIVE/assets/img/logo.png" width="50px"> <br> <br>
          <div class="sidebar-brand-text mx-3">SPK SAW</div> <br>
          <div class="sidebar-brand-text mx-3 text-center">Program Keluarga Harapan (PKH)</div>
        </div>
      </a>
      ...
      ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" data-toggle="modal" data-target="#periode">
            <i class="fas fa-fw fa-edit"></i>
            <span>Periode PKH</span></a>
        </li>
        ...
        <li class="nav-item <?php if ($page == "Hasil") {
          ...
          <a class="nav-link" href="hasil.php?kouta=<?= isset($_GET['kouta']) ? $_GET['kouta'] : '' ?>&tahap=<?= isset($_GET['tahap']) ? $_GET['tahap'] : '' ?>&tahun=<?= isset($_GET['tahun']) ? $_GET['tahun'] : '' ?>">
        ...
        <li class="nav-item">
          ...
          <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="cetak-data-kriteria.php?tahap=<?= isset($_GET['tahap']) ? $_GET['tahap'] : '' ?>&tahun=<?= isset($_GET['tahun']) ? $_GET['tahun'] : '' ?>">Data Kriteria</a>
              <a class="collapse-item" href="cetak-data-sub-kriteria.php">Data Sub Kriteria</a>
              <a class="collapse-item" href="cetak-data-peserta.php">Data Peserta</a>
              <a class="collapse-item" href="cetak-data-penilaian.php">Data Penilaian</a>
              <a class="collapse-item" href="cetak.php?kouta=<?= isset($_GET['kouta']) ? $_GET['kouta'] : '' ?>&tahap=<?= isset($_GET['tahap']) ? $_GET['tahap'] : '' ?>&tahun=<?= isset($_GET['tahun']) ? $_GET['tahun'] : '' ?>">Data Hasil Akhir</a>
            </div>
          </div>
        </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h4 class="font-weight-bold">KELURAHAN KEMUNING</h4>
