...
<div class="mb-4">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-home"></i> Dashboard</h1>
         <img src="/SPK-SAW-NATIVE/assets/img/logo_stmik.png" width="85px">
    </div>
...
<b>Developed by Students of STMIK Banjarbaru named :</b> <br>
<ul>
<li>Muhammad Zaini Redha (NIM 310120023560)</li>
</ul>
</div>
