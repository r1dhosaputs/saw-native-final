...
if ($user_role == 'admin') {
	...
	if (isset($_POST['submit'])) {
		...
		if (empty($errors)) {
			...
			$sql = "UPDATE kriteria SET kode_kriteria = :kode_kriteria, nama = :nama, type = :type, bobot = :bobot WHERE id_kriteria = :id_kriteria";
			...
			// Eksekusi statement untuk melakukan update
			try {
				$stmt->execute();
				$sukses = true;
			} catch (PDOException $e) {
				$errors[] = 'Data gagal diupdate: ' . $e->getMessage();
			}
